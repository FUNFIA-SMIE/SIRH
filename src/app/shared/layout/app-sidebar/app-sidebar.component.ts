  ...
  navItems: NavItem[] = [
    /*
    {
      ...
      subItems: [
        ...
        { name: "RH", path: "/dashboard-rh" },
        { name: "Présences", path: "/dashboard-presence" },
        { name: "Paie", path: "/dashboard-paie" },
      ],
    },
*/
    {
      ...
      name: "Employés",
      subItems: [
        { name: "Tous les employés ", path: "/dashboard/all_employees" },
        { name: "Département ", path: "/dashboard/departement" },
        { name: "Poste ", path: "/dashboard/poste" },
...
/*
    {
      ...
      name: "Contrats",
      subItems: [
        { name: "Contrats actifs", path: "/" },
        { name: "Fin de contrat", path: "/" },
        { name: "Avenants", path: "/" },
...
*/

    {
      ...
      subItems: [
        { name: "Demandes en attente", path: "/dashboard/demande-en-attente" },
        { name: "Calendrier", path: "/dashboard/calendrier-conge" },
        { name: "Soldes", path: "/dashboard/soldes" },
        { name: "Configuration", path: "/dashboard/configuration-conge" },
...

    {
      ...
      name: "Pointage",
      subItems: [
        { name: "Relevés journaliers", path: "/dashboard/releve_journ" },
        { name: "Heures supp", path: "/dashboard/heures_supp" },
      //  { name: "Anomalies", path: "/dashboard" },
      //  { name: "Configuration", path: "/dashboard" },
...
/*
    {
      ...
      name: "Rapports & KPI",
      subItems: [
        { name: "Tableaux de bord", path: "/" },
        { name: "Rapports RH", path: "/" },
        { name: "Exports légaux ", path: "/" },
      ],
    },
