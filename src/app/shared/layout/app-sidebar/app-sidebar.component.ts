...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
...

    {
      ...
      name: "Employés",
      subItems: [
        { name: "Tous les employés ", path: "/all_employees" },
        { name: "Département ", path: "/departement" },
        { name: "Poste ", path: "/poste" },
...

    {
      ...
      subItems: [
        { name: "Demandes en attente", path: "/demande-en-attente" },
        { name: "Calendrier", path: "/calendrier-conge" },
        { name: "Soldes", path: "/soldes" },
        { name: "Configuration", path: "/configuration-conge" },
